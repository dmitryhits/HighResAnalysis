...
__all__ = ['MaxADC', 'MinPH', 'MaxPH', 'PHBinWidth', 'MinVcal', 'MaxVcal', 'TP', 'get_time', 'get_local', 'get_local_x',
           'get_local_y', 'get_corr', 'get_global', 'get_xy', 'get_global_x', 'get_x', 'get_y', 'get_pixel', 'get_adc',
           'get_vcal', 'get_electrons', 'get_ph', 'get_triggerphase']
