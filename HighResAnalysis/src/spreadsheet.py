...
# %% auto 0
__all__ = ['scope', 'creds', 'client', 'file_name', 'info', 'colnum_string', 'make_timestamp', 'make_desy_run_log',
           'load_cern_sheet', 'make_cern_run_log', 'make']
...
# %% ../../nbs/31_src.spreadsheet.ipynb 15
def make(bt):
