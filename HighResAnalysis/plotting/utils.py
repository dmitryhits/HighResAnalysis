...
# %% auto 0
__all__ = ['ON', 'OFF', 'RED', 'GREEN', 'get_t_str', 'colored', 'prnt_msg', 'info', 'add_to_info', 'warning', 'critical',
           'get_stat', 'choose', 'round_up_to', 'do', 'do_nothing', 'is_iter', 'is_ufloat', 'uarr2n', 'uarr2s', 'arr2u',
           'add_err', 'add_perr', 'eff2u', 'make_ufloat', 'make_list', 'prep_kw', 'get_kw', 'rm_key', 'mean_sigma',
           'calc_eff', 'cart2pol', 'pol2cart', 'get_x', 'get_y', 'ensure_dir', 'remove_file', 'correlate', 'add_spaces',
...
# %% ../../nbs/06_plotting.utils.ipynb 60
...
# %% ../../nbs/06_plotting.utils.ipynb 63
...
# %% ../../nbs/06_plotting.utils.ipynb 64
...
# %% ../../nbs/06_plotting.utils.ipynb 70
...
# %% ../../nbs/06_plotting.utils.ipynb 71
def correlate(l1, l2):
    if len(l1.shape) == 2:
...
# %% ../../nbs/06_plotting.utils.ipynb 72
def add_spaces(s):
...
# %% ../../nbs/06_plotting.utils.ipynb 73
...
# %% ../../nbs/06_plotting.utils.ipynb 76
...
# %% ../../nbs/06_plotting.utils.ipynb 77
class AsymVar:
...
# %% ../../nbs/06_plotting.utils.ipynb 78
def aufloat(n, s0=0, s1=0):
    return AsymVar(n, s0, s1)

# %% ../../nbs/06_plotting.utils.ipynb 79
...
# %% ../../nbs/06_plotting.utils.ipynb 80
